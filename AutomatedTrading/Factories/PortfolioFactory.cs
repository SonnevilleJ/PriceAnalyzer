...
namespace Sonneville.PriceTools.AutomatedTrading
{
    ...
    public static class PortfolioFactory
    {
        ...
        public static IPortfolio ConstructPortfolio(params ITransaction[] transactions)
        {
        ...
        /// <param name="transactions">The list of <see cref="ITransaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        public static IPortfolio ConstructPortfolio(DateTime dateTime, decimal openingDeposit, params ITransaction[] transactions)
        {
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="ITransaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        public static IPortfolio ConstructPortfolio(DateTime dateTime, decimal openingDeposit, IEnumerable<ITransaction> transactions)
        {
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="ITransaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        public static IPortfolio ConstructPortfolio(string ticker, DateTime dateTime, decimal openingDeposit, params ITransaction[] transactions)
        {
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="ITransaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        public static IPortfolio ConstructPortfolio(string ticker, DateTime dateTime, decimal openingDeposit, IEnumerable<ITransaction> transactions)
        {
