...
namespace Sonneville.PriceTools.AutomatedTrading
{
    public interface IPortfolioFactory
    {
        ...
        IPortfolio ConstructPortfolio(params Transaction[] transactions);

        /// <summary>
        /// Constructs a Portfolio from a <see cref="ISecurityBasket"/>.
        /// </summary>
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(IEnumerable<Transaction> transactions);
        ...
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(string ticker, params Transaction[] transactions);
        ...
        /// <param name="ticker">The ticker symbol which is used as the <see cref="ICashAccount"/>.</param>
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(string ticker, IEnumerable<Transaction> transactions);
        ...
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(DateTime dateTime, decimal openingDeposit, params Transaction[] transactions);
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(DateTime dateTime, decimal openingDeposit, IEnumerable<Transaction> transactions);
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(string ticker, DateTime dateTime, decimal openingDeposit, params Transaction[] transactions);
        ...
        /// <param name="openingDeposit">The cash amount deposited into the Portfolio.</param>
        /// <param name="transactions">The list of <see cref="Transaction"/>s currently in the <see cref="IPortfolio"/>.</param>
        IPortfolio ConstructPortfolio(string ticker, DateTime dateTime, decimal openingDeposit, IEnumerable<Transaction> transactions);
    }
}