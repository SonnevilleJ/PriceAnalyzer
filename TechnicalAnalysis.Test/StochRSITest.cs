...
namespace Sonneville.PriceTools.TechnicalAnalysis.Test
{
    class StochRSITest : CommonIndicatorTests<StochRSI>
    {
        ...
        private ITimeSeries<ITimePeriod<decimal>, decimal> _timeSeries;
        ...
        protected override StochRSI GetTestObjectInstance(ITimeSeries<ITimePeriod<decimal>, decimal> timeSeries, int lookback)
        {
