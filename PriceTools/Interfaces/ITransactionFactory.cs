...
namespace Sonneville.PriceTools
{
    public interface ITransactionFactory
    {
        ...
        /// <returns></returns>
        IDeposit ConstructDeposit(DateTime settlementDate, decimal amount);
        ...
        /// <returns></returns>
        IDividendReceipt ConstructDividendReceipt(DateTime settlementDate, decimal amount);
        ...
        /// <param name="commission"></param>
        /// <returns></returns>
        ISell ConstructSell(string ticker, DateTime settlementDate, decimal shares, decimal price, decimal commission = 0.00m);
        ...
        /// <param name="commission"></param>
        /// <returns></returns>
        IBuyToCover ConstructBuyToCover(string ticker, DateTime settlementDate, decimal shares, decimal price, decimal commission = 0.00m);
