...
namespace Sonneville.PriceTools.Implementation
{
    ...
    /// </summary>
    [Serializable]
    internal sealed class DividendReinvestmentImpl : ShareTransactionImpl, IDividendReinvestment
    {
        /// <summary>
        /// Constructs a DividendReinvestment.
        /// </summary>
        internal DividendReinvestmentImpl(Guid factoryGuid, string ticker, DateTime settlementDate, decimal shares, decimal price, decimal commission)
