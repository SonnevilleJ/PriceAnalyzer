...
namespace Sonneville.PriceTools.Test
{
    ...
    public class OrderTest
    {
        ...
        public void IssuedAfterExpiredFails()
        {
            ...
            Order.Factory.ConstructOrder(issued, expired, orderType, ticker, shares, price);
        }
        ...
        public void PricingTypeTest()
        {
            ...
            var target = Order.Factory.ConstructOrder(issued, expired, orderType, ticker, shares, price, pricingType);
        ...
        public void BinaryAndedPricingTypeTest()
        {
            ...
            for (var i = min; i < max; i++)
            {
                ...
                try
                {
                    Order.Factory.ConstructOrder(issued, expired, orderType, ticker, shares, price, pricingType);
        ...
        public void ManualStopMarketPricingTypeTest()
        {
            ...
            var order = Order.Factory.ConstructOrder(issued, expired, orderType, ticker, shares, price, pricingType);
