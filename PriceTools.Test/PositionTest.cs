...
namespace Sonneville.PriceTools.Test
{
    ...
    public class PositionTest
    {
        ...
        [TestMethod]
        public void CalculateNetProfitReturnsCorrectOpenPosition()
        {
            const string ticker = "DE";
            var target = PositionFactory.CreatePosition(ticker);
        ...
        [TestMethod]
        public void CalculateNetProfitReturnsCorrectAfterGain()
        {
            const string ticker = "DE";
            var target = PositionFactory.CreatePosition(ticker);
        ...
        [TestMethod]
        public void CalculateNetProfitReturnsCorrectAfterLoss()
        {
            const string ticker = "DE";
            var target = PositionFactory.CreatePosition(ticker);
