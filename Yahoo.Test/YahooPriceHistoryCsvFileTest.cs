...
namespace Sonneville.PriceTools.Yahoo.Test
{
    ...
    public class YahooPriceHistoryCsvFileTest
    {
        ...
        public void PriceHistoryCsvFileWillCorrectWeekendTailWeeklyTest()
        {
            ...
            var seriesTail = new DateTime(2011, 7, 2, 23, 59, 59);              // Saturday
            var priceSeries = new YahooPriceHistoryCsvFile(TestUtilities.GetUniqueTicker(), new ResourceStream(SampleCsvPriceHistory.MSFT_Apr_June_2011_Weekly_Google), seriesHead, seriesTail).PriceSeries;
        ...
        public void YahooDailyTestDates()
        {
            ...
            var target = SamplePriceHistoryCsvFiles.IBM_1_1_2011_to_3_15_2011_Daily_Yahoo;
